...
async def test_conversation_persisted_redacted_when_enabled(repo, vector_store, embedding, llm):
...
async def test_conversation_stored_as_is_without_redactor(repo, vector_store, embedding, llm):
    from application.services.retriever import RetrieverService
